'''
Justin's rf_sweep.py file from github
'''
...
from ..Utilities.saver import *
from ..Instruments.VNA_6GHz import VNA8753D
...
class RFSweepCurrent:
    ...
    def __init__(self, k_Istart, k_Istop, k_Isteps, v_freqmin, v_freqmax, v_power, v_avg_factor, v_numpoints,
        ...
        try:
            ...
            print(e)
            print("didn't find Keithley2400, looking for Keithley2450")
            self.k3 = Keithley2450(18)
        self.v1 = VNA8753D(16)  # initialize VNA (Instrument object)
